...
void sj2_cli__init(void) {
  ...
  static app_cli__command_s suspend_resume = {.command_name = "taskcontrol",
                                              .help_message_for_command = "Allows user to suspend/resume a task",
                                              .app_cli_handler = cli__suspend_resume};

  static app_cli__command_s play = {
      .command_name = "play", .help_message_for_command = "Allows user to play music", .app_cli_handler = cli__play};

  static app_cli__command_s pause_resume = {.command_name = "music",
                                            .help_message_for_command = "Allows user to pause or resume music",
                                            .app_cli_handler = cli__pause_resume};
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &suspend_resume);
  app_cli__add_command_handler(&sj2_cli_struct, &play);
  app_cli__add_command_handler(&sj2_cli_struct, &pause_resume);
